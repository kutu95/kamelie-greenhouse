              ...
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center bg-green-600/20 text-green-100 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  <Image
                    ...
                    className="mr-2"
                  />
                  Seit 1990 - Deutschlands größte Sammlung
                </div>
                <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
                  Willkommen bei
                  <span className="block text-green-300">Kamelie Greenhouse</span>
                </h1>
                <p className="text-xl md:text-2xl text-green-100 mb-6 font-light">
                  Über 3.000 Kamelienpflanzen in unserem Gewächshaus
                </p>
                <p className="text-lg text-green-200 mb-12 max-w-2xl leading-relaxed">
                  Entdecken Sie unsere exklusive Sammlung von über 3.000 Kamelienpflanzen. 
                  Über 35 Jahre Erfahrung in der Kamelienzucht und persönliche Beratung.
                </p>
              ...
              <div className="relative">
                ...
                <div className="absolute -top-4 -left-4 bg-white rounded-xl p-4 shadow-xl border border-green-100">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-semibold text-gray-800">2.000 m² Gewächshaus</span>
                  </div>
                </div>
                <div className="absolute -bottom-4 -right-4 bg-white rounded-xl p-4 shadow-xl border border-emerald-100">
                  <div className="flex items-center space-x-3">
                    <div className="w-4 h-4 bg-emerald-500 rounded-full animate-pulse"></div>
                    <span className="text-sm font-semibold text-gray-800">3.000+ Pflanzen</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              Warum Kamelie Greenhouse?
            </div>
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Über 35 Jahre Leidenschaft für Kamelien
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Von der privaten Leidenschaft zu Deutschlands größter Kameliensammlung - 
              persönlicher Service und fachliche Expertise seit 1990
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Über 35 Jahre Erfahrung in der Kamelienzucht und kontinuierliche Weiterbildung
              </p>
            </div>
            ...
            <div className="text-center group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Individuelle Beratung zu Standort, Pflege und Sortenauswahl
              </p>
            </div>
            ...
            <div className="text-center group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Besuchen Sie unser modernes Gewächshaus mit optimalen Bedingungen
              </p>
            </div>
            ...
            <div className="text-center group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Erleben Sie die spektakuläre Blütezeit von Februar bis April
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Entdecken Sie die Vielfalt unserer Kameliensammlung
              </p>
            </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl group cursor-pointer">
                <div className="aspect-[4/3] bg-gradient-to-br from-green-100 via-green-200 to-emerald-200 flex items-center justify-center relative">
                  ...
                  <div className="text-center relative z-10">
                    ...
                    <h4 className="text-green-800 font-bold text-lg mb-2">Kamelien-Sammlung</h4>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-end p-6">
                  <div className="text-white">
                    <p className="font-semibold text-lg mb-1">Kamelien-Sammlung</p>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl group cursor-pointer">
                <div className="aspect-[4/3] bg-gradient-to-br from-pink-100 via-pink-200 to-rose-200 flex items-center justify-center relative">
                  ...
                  <div className="text-center relative z-10">
                    ...
                    <h4 className="text-pink-800 font-bold text-lg mb-2">Blühende Kamelien</h4>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl group cursor-pointer">
                <div className="aspect-[4/3] bg-gradient-to-br from-emerald-100 via-emerald-200 to-teal-200 flex items-center justify-center relative">
                  ...
                  <div className="text-center relative z-10">
                    ...
                    <h4 className="text-emerald-800 font-bold text-lg mb-2">Gewächshaus</h4>
                    <p className="text-emerald-700 text-sm">2.000 m² Fläche</p>
                  </div>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-end p-6">
                  <div className="text-white">
                    <p className="font-semibold text-lg mb-1">Gewächshaus</p>
            ...
            <div className="text-center mt-8">
              <p className="text-gray-500 text-sm mb-4">
                💡 Tipp: Klicken Sie auf die Bilder für eine größere Ansicht
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Öffnungszeiten während der Kameliensaison (März - Mai)
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Entdecken Sie unsere Kameliensammlung
          </h2>
          <p className="text-xl text-green-100 mb-10 max-w-2xl mx-auto">
            Über 3.000 Pflanzen in verschiedenen Größen und Sorten. 
            Von klassischen Sorten bis zu seltenen Raritäten.
          </p>
