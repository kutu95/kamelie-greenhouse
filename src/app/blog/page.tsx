...
export default function BlogPage() {
  ...
  const blogPosts = [
    {
      id: 1,
      title: 'Die beste Zeit für Kamelien-Pflege',
      excerpt: 'Erfahren Sie, wann und wie Sie Ihre Kamelien am besten pflegen sollten, um eine üppige Blüte zu erzielen.',
    ...
    {
      id: 2,
      title: 'Kamelien-Sorten für den Garten',
      excerpt: 'Entdecken Sie die vielfältigen Kamelien-Sorten, die sich perfekt für Ihren Garten eignen.',
    ...
    {
      id: 3,
      title: 'Überwinterung von Kamelien',
      excerpt: 'Tipps und Tricks für die erfolgreiche Überwinterung Ihrer Kamelien im Gewächshaus.',
      content: 'Die Überwinterung ist ein entscheidender Faktor für gesunde Kamelien...',
      author: 'Michael von Allesch',
      date: '2024-01-05',
      readTime: '6 min',
      category: 'Überwinterung',
      image: '/images/hero/quartier-grosspflanzen.jpg',
      featured: false
    },
    {
      id: 4,
      title: 'Geschichte der Kamelien in Deutschland',
      excerpt: 'Eine Reise durch die Geschichte der Kamelienzucht in Deutschland und unsere Rolle dabei.',
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
              Everything About Camellias
            </h1>
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
              Discover tips, tricks and stories from over 35 years of camellia experience
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-16 bg-green-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-green-100 mb-8 max-w-2xl mx-auto">
            Subscribe to our newsletter and receive regular tips and news about camellias.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg">
            <div className="text-center mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                Have Questions About Camellias?
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Our team is happy to help you with advice and support. Contact us for personal consultation.
              </p>
            </div>
