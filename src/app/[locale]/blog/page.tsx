        ...
        <div className="container mx-auto px-4 py-8 sm:py-12">
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
              Entdecken Sie Tipps, Tricks und Geschichten aus über 35 Jahren Kamelien-Erfahrung
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-16 bg-green-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-green-100 mb-8 max-w-2xl mx-auto">
            Abonnieren Sie unseren Newsletter und erhalten Sie regelmäßig Tipps und Neuigkeiten rund um Kamelien.
          </p>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Unser Team steht Ihnen gerne mit Rat und Tat zur Seite. Kontaktieren Sie uns für eine persönliche Beratung.
              </p>
            </div>
